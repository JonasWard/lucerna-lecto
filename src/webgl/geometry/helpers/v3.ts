...
export class V3 {
  ...
  private static massAdd = (vertices: V3[]): V3 =>
    vertices.reduce((a, b) => ({ x: a.x + b.x, y: a.y + b.y, z: a.z + b.z }), { x: 0, y: 0, z: 0 })
  ...
  public static getUnit = (v: V3): V3 =>
    V3.getLengthSquared(v) > V3.zeroToleranceSquared ? V3.mul(v, 1 / V3.getLength(v)) : V3.Origin
  ...
  public static curveForQuad = (f: QuadFace, uvs: V2[]): V3[] =>
    uvs.map((uv) =>
      V3.add(
        V3.mul(f.v00, (1 - uv.u) * (1 - uv.v)),
        V3.mul(f.v10, (1 - uv.u) * uv.v),
        V3.mul(f.v01, uv.u * (1 - uv.v)),
        V3.mul(f.v11, uv.u * uv.v)
      )
    )
